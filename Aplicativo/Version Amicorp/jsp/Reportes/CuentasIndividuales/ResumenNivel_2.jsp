...
<html>
                  ...
                  <tr>
                      ...
                      <td width="70%">
                          <table width="100%" height="100%">
                                ...
                                <tr><td>&nbsp;</td></tr>
                                <tr><td style="font-weight:bolder; font-family: Arial; 10px;" align="center" width="89%">Resumen por <%=(nomNivel2=="")?"&nbsp;":nomNivel2%></td></tr>
                                <tr>
  ...
  %>
          ...
          <tr>
            ...
            <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><%=(subTotNoInvers.intValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###", subTotNoInvers)%></td>
            <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><%=(subTotSaldoAnt.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", subTotSaldoAnt)%></td>
            <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><%=(subTotDepositos.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", subTotDepositos)%></td>
            <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><%=(subTotRetiros.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", subTotRetiros)%></td>
            <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><%=(subTotIntereses.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", subTotIntereses)%></td>
            <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><%=(subTotIsr.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", subTotIsr)%></td>
            <%if(existeParticipacion!=0){%> 
            <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><%=(subTotParticipacion.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", subTotParticipacion)%></td>
            <%}%>
            <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><%=(subTotSaldoFinal.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", subTotSaldoFinal)%></td>
          </tr>
  <%
          totNoInvers = new BigDecimal(totNoInvers.intValue() + subTotNoInvers.intValue());
          totSaldoAnt = new BigDecimal(totSaldoAnt.doubleValue() + subTotSaldoAnt.doubleValue());
          totDepositos = new BigDecimal(totDepositos.doubleValue() + subTotDepositos.doubleValue());
          totRetiros = new BigDecimal(totRetiros.doubleValue() + subTotRetiros.doubleValue());
          totIntereses = new BigDecimal(totIntereses.doubleValue() + subTotIntereses.doubleValue());
          totIsr = new BigDecimal(totIsr.doubleValue() + subTotIsr.doubleValue());
          totParticipacion = new BigDecimal(totParticipacion.doubleValue() + subTotParticipacion.doubleValue());
          totSaldoFinal = new BigDecimal(totSaldoFinal.doubleValue() + subTotSaldoFinal.doubleValue());
          
          subTotNoInvers = new BigDecimal(0);
  ...
  %>
        <tr><td colspan="9">&nbsp;</td></tr>
        <tr><td colspan="9">&nbsp;</td></tr>
        <tr><td colspan="9"><%=(numN1.intValue()!=0)?numN1.toString():"&nbsp;"%>     <%=(nomN1=="")?"&nbsp;":nomN1%></td></tr>
        
        <tr>
          <td width="200" style="font-weight:bolder; font-family: Arial; 10px;" align="center">&nbsp;</td>
  ...
  <%
      ...
      {
        //Hacer las sumas para mostrar los sub-totales
        subTotNoInvers = new BigDecimal(subTotNoInvers.intValue() + numInver.intValue());
  ...
  %>
        <tr>
          <td style="font-weight:bolder; font-size:9pt;" width="25%"><%=(numN2.intValue()!=0)?numN2.toString():"&nbsp;"%>     <%=(nomN2=="")?"&nbsp;":nomN2%></td>
          <td align="right" style="font-weight; font-family: Arial; font-size:11pt;"><%=(numInver.intValue()==0)?"0":DecimalFormatUtils.getFormatedNumber("###,###", numInver)%></td>
  ...
  %>
        ...
        <tr>
          <td style="font-weight:bolder; font-family: Arial; 10px;">Subtotales</td>
          <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><%=(subTotNoInvers.intValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###", subTotNoInvers)%><hr/></td>
        ...
        <tr>
          <td style="font-weight:bolder; font-family: Arial; 10px;">Totales</td>
          <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><hr/><%=(totNoInvers.intValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###", totNoInvers)%></td>
          <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><hr/><%=(totSaldoAnt.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", totSaldoAnt)%></td>
          <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><hr/><%=(totDepositos.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", totDepositos)%></td>
          <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><hr/><%=(totRetiros.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", totRetiros)%></td>
          <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><hr/><%=(totIntereses.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", totIntereses)%></td>
          <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><hr/><%=(totIsr.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", totIsr)%></td>
          <%if(existeParticipacion!=0){%> 
          <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><hr/><%=(totParticipacion.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", totParticipacion)%></td>
          <%}%>
          <td style="font-weight:bolder; font-family: Arial; 10px;" align="right"><hr/><%=(totSaldoFinal.doubleValue()==0.0)?"0.00":DecimalFormatUtils.getFormatedNumber("###,###.00", totSaldoFinal)%></td>
        </tr>
