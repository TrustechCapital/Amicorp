...
if(reporte.hasData()==true)
  ...
  String añoActual = reporte.getVtrStrDato4().substring(reporte.getVtrStrDato4().length()-4,reporte.getVtrStrDato4().length());
	//periodo= " DEL "+((añoApertura.equals(añoActual))?apertura.split(" DEL ")[0]:"1 DE ENERO")+" AL " + reporte.getVtrStrDato4();
