  ...
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
         ...
         <tr>
          ...
          <tr>
            ...
            <td colspan="3" align="center">
              <iframe id="frameUpload" align="middle" style="z-index:1;" src="<%=request.getContextPath()%>/modules/Garantias/Inmuebles/CargaMasiva/FileUpload.do" frameborder="0" scrolling="no" width="100%" height="100px" AllowTransparency>
              </iframe>
            </td>
            <td width="15%">&nbsp;</td>
          </tr>
    ...
    <tr>
      <td align="center">&nbsp;
        ...
        <input type="button" value="Limpiar" name="cmdLimpiar" id="cmdLimpiar" class="boton" onclick="limpiar()" style="visibility:hidden"/>
      </td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
