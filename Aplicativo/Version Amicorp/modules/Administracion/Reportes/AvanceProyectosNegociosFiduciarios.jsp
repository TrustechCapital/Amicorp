...
<input type="hidden" id="refSP" name="refSP" value="repInventarioNegociosMon"/>
<input type="hidden" id="refQry" name="refQry" value="getInventarioNegociosMon"/>
<input type="hidden" id="paramsendToJSP" name="paramsendToJSP" value="true"/>
<input type="hidden" id="paramurlReporte" name="paramurlReporte" value="/jsp/Reportes/Administracion/AvanceProyectosNegociosFiduciarios.jsp"/>
...
<table border="0" cellpadding="1" class="texto" cellspacing="5" width="100%">
  ...
  <tr>   
    <td>Tipo Alertamiento:</td>
    <td>
	<select size="1" name="paramAlertamiento" id="paramAlertamiento" ref="cves" fun="loadComboElementDo" keyValue="cveDescClave" theValue="cveDescClave" next="formsLoaded"  param="cmbObligacionesFiscalesParam">
	<option value="-1">-- Seleccione --</option>
	<option value="INUSUAL">INUSUAL</option>
	<option value="RELEVANTE">RELEVANTE</option>
	<option value="24HORAS">24 HORAS</option>
	<option value="INTERNA">INTERNA PREOCUPANTE</option>
	<option value="INTERNA">BLOQUEADA</option>
	</select>
