          ...
          <table width="90%" align="center" class="texto"> 
           <tr valign="middle">
              ...
              <td>
                ...
                <input type="checkbox" id="edito" name="edito" onclick="if(this.checked){GI('paramnumUsu').name ='paramusuMod';GI('paramnumUsu').id ='paramusuMod';}else{GI('paramusuMod').name ='paramnumUsu';GI('paramusuMod').id ='paramnumUsu';}">&nbsp;Ultima Modificación
              </td>
            </tr>
            ...
            <tr valign="middle">
              ...
              <td width="25%"><input type="checkbox" id="siUnAno" name="siUnAno" onclick="if(this.checked){SA(GI('cmdAceptar'),'ref','qryConsultaAgendaUnAno')}else{SA(GI('cmdAceptar'),'ref','qryConsultaAgenda')}">&nbsp;Completar Año</td>
            </tr>
            <tr valign="middle">
              <td width="25%">&nbsp;</td>
            ...
            <tr valign="middle">
              <td width="25%">&nbsp;</td>
              <td nowrap colspan=2>
                <input type="checkbox" name="chkQryProy" id="chkQryProy" class="check"/>
            ...
            <tr align="center">            
              ...
              <div id="div_resultados" align="center">
               ...
               <input style="position:absolute;visibility:hidden;" type="BUTTON" value="Aceptar2" id="cmdAceptar2" name="cmdAceptar2" class="boton"  ref="qryConsultaAgendaProyecciones" fun="loadTableElement" tabla="tablaConsultaProyecciones" onclick="consultaProyecciones(this);"></td>
               ...
               <table cellspacing="0" cellpadding="0" border="0">
                  <tr align="left" class="cabeceras">
                    ...
                    <td width="580px">Descripción</td>                 
                    <td width="100px">Estatus</td>
                  </tr>
                </table>
                <div style="height:200px; overflow:auto; position:relative; vertical-align:top; width:1080px;">
                  <table id="tablaConsultaProyecciones" border="0" cellspacing="0" cellpadding="0" dataInfo="tablaAgendaProyecciones" keys="eageIdFolio,eageFecEvento" fun="clickTablaProy" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de búsqueda">
                  </table>
                </div> 
            </div>
