          ...
          <table width="90%" align="center" class="texto">
              ...
              <table cellpadding="0" cellspacing="0">
                <tr>                  
                   ...
                   <td width="112"  align="center" valign="middle"> <input type="BUTTON" value="Consultar" id="cmdConsultar" name="cmdConsultar" onmouseover="this.className='boton_rightSobre'" onmouseout="this.className='boton_right';" class="boton_right" onclick="cargaMantenimientoFideicomitentes(3)"/> </td>                   
					<td width="112"  align="center" valign="middle"> <input type="BUTTON" value="Prop Real" id="cmdPropReal" name="cmdPropReal" onmouseover="this.className='boton_rightSobre'" onmouseout="this.className='boton_right';" class="boton_right" onclick="cargaMantenimientoFideicomitentes(4)"/> </td>                   				   
                  </td>
                </tr>
            </table>
            ...
            <tr align="center">
              <td colspan="5">
                ...
                <div style="height:150px; overflow:auto; position:relative; vertical-align:top; width:693px;">
                  <table id="tablaRegistrosFideicomitentes" border="0" cellspacing="0" cellpadding="0" dataInfo="tablaFideicomitentesData" keys="fidNumContrato,fidFideicomitente,honPjeFragComis" fun="clickTabla" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de b�squeda">
                  </table>
                </div>
              </td>
            </tr>
