      ...
      <td height="100%">
        <table width="100%" align="center" class="texto">
          ...
          <tr>
            ...
            <td colspan="7">
              <input type="checkbox" name="smayor" id="smayor" onclick="soloMayor(this)" class="check"/>&nbsp;Sólo Mayores
            </td>
            <td align="center">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="11" align="center">
              ...
              <div style="height:250px; width:1138; overflow:auto; position:relative; vertical-align:top;">
