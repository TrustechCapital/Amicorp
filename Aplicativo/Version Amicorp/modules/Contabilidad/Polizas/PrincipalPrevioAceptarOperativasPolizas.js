...
function cargaPrincipalPrevioAceptarOperativasPolizas(){
  ...
  var urlCliente = "modules/Contabilidad/Polizas/PrincipalPrevioAceptarOperativasPolizas.do";
...
function validaStoreContabiliza(obj, result){
  ...
  if(resultado[1] != 0){
    alert(resultado[0]);
    onButtonClickPestania("Contabilidad.Polizas.PrincipalOperativasPolizas","")
  }else{
