      ...
      <td height="100%">
        <table width="100%" class="texto">
          <tr>
            ...
            <td colspan="4">
              <!-- #01 -->
              <input type="text" name="txtNombre" id="txtNombre" size="60" maxlength="60" onblur="cmbPolizaParam.Nombre = this.value;cargaCmbPolizas();"/>
            </td>
            <td>
          ...
          <tr>
            ...
            <td colspan="3" width="50%">
              <select size="1" name="cmbPoliza" id="cmbPoliza" ref="conOpe" fun="loadComboElement" keyValue="opeNumOperacion" theValue="opeNomOperacion" param="cmbPolizaParam" next="hideWaitLayer" onchange="cargaVariablesPoliza(this);" required message="La Póliza es un campo obligatorio"/>
...
tipo="Money" required />
    ...
    <tr>
      <td height="100%" align="center">
        ...
        <input type="button" value="Limpiar" name="cmdLimpiar" id="cmdLimpiar" class="boton" onclick="onButtonClickPestania('Contabilidad.Polizas.PrincipalOperativasPolizas','');"/>
      </td>
    </tr>
  </table>
</form>
