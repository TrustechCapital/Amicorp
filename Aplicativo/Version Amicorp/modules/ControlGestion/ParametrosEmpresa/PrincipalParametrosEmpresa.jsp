<FORM name="frmDatos" id="frmDatos" onsubmit="">
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
    <tr>
      <td align="center" height="100%" class="titulo">Par&aacute;metros Instituci&oacute;n</td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
    </tr>
    <tr>
      <td height="100%">
        <table width="100%" align="center" class="texto">
          <tr>
            <td width="40%">&nbsp;</td>
            <td nowrap width="15%">Instituci&oacute;n</td>
              <td nowrap colspan="2">
                <select size="1" name="paramempresa" id="paramempresa" ref="cmbParamEmpresa" fun="loadComboElement" keyValue="empNumEmpresa" theValue="empNomEmpresa"  param="cmbEmpresas" next="formsLoaded"/>
            <td width="40%">
              &nbsp;
            </td>
            <td width="15%">&nbsp;</td>
          ...
          <tr>
            ...
            <table width="224" cellpadding="0" cellspacing="0">
                ...
                <td width="112"  align="center" valign="middle">
                  <input type="BUTTON" value="Aceptar" id="cmdAceptar" name="Aceptar" class="boton_left" onmouseover="this.className='boton_leftSobre'" onmouseout="this.className='boton_left';" ref="qryParamEmpresa" fun="loadTableElement" tabla="tabla" onclick="if(fvMantenimiento.checkForm())consultar(this, GI('frmDatos'), false);">
                  </td>
                  <td width="112" align="center" valign="middle">
            ...
            <td colspan="5">
              <table cellspacing="0" cellpadding="0" border="0">
                <tr align="left" class="cabeceras">
                  ...
                  <td width="300px">Instituci&oacute;n</td>
                  <td width="200px">Área</td>
                  <td width="200px">Autoriza</td>
                  <td width="200px">Firma</td>
                  <td width="80px">Procedimiento</td>
                </tr>
              </table>
              <div style="height:250px; overflow:auto; position:relative; vertical-align:top;">
                <table id="tabla" border="0" cellspacing="0" cellpadding="0" dataInfo="tablaData" keys="empNumEmpresa" fun="clickTabla" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de búsqueda">
                </table>
              </div>
            </td>
          </tr>
