  ...
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
      ...
      <td height="100%">
        <table width="100%" class="texto">
          ...
          <tr>
            ...
            <td  cplspan=3>
              <input type="text" name="perNivelEstudios" id="perNivelEstudios" size="40" maxlength="50" required message="El correo electrónico es un campo obligatorio"/>
            </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td width="35%">
              <input type="text" name="perClave" id="perClave" size="8" maxlength="8" required message="La Clave es un campo obligatorio" onblur="convertirMayusculas(this)"/>
            </td>
          ...
          <tr>
            ...
            <td width="35%">
              <input type="text" name="perRangoNivel" id="perRangoNivel" size="10" maxlength="10" required message="El Nivel es un campo obligatorio" onblur="convertirMayusculas(this)"/>
            </td>
          ...
          <tr>
            ...
            <td width="35%">
              <input type="text" name="perRfc" id="perRfc" size="20" maxlength="20" required message="El RFC es un campo obligatorio" onblur="convertirMayusculas(this)"/>
            </td>
            <td nowrap width="8%">&nbsp;</td>
            <td>&nbsp;
            </td>
          ...
          <tr>
            ...
            <td colspan="3">
              <textarea name="perDireccion" id="perDireccion" style="width:400px;height:80px" onkeydown="validaLongitud(this,110);" required message="La Dirección es un campo obligatorio" onblur="convertirMayusculas(this)"></textarea>
            </td>
            <td>&nbsp;</td>
          </tr>
          <tr>
            ...
            <td width="35%">
              <input type="radio" name="rdEdoCivil" id="perEdoCivil" class="radio" value2="1" onclick="asignaValueRadio2Master('perEdoCivil',this)" required message="El Estado Civil es un dato obligatorio"/>Soltero</td>
            <td nowrap width="8%">
            </td>
            <td>
            </td>
          ...
          <tr>
            ...
            <td nowrap width="7%">&nbsp;</td>
            <td width="35%">
              <input type="radio" name="rdEdoCivil" id="perEdoCivil2" class="radio" value="2" onclick="asignaValueRadio2Master('perEdoCivil',this)"/>Divorciado</td>
            <td nowrap width="8%">
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
           ...
           <tr>
            ...
            <td nowrap width="7%">&nbsp;</td>
            <td width="35%">
              <input type="radio" name="rdEdoCivil" id="perEdoCivil4" class="radio" value="4" onclick="asignaValueRadio2Master('perEdoCivil',this)"/>Viudo</td>
            <td nowrap width="8%">
            </td>
            <td>&nbsp;</td>
            <td>&nbsp;</td>
    ...
    <tr>
      <td width="60%" height="100%">
        ...
        <input type="text" name="perHonInic" id="perHonInic" size="1" maxlength="40" value=" " style="visibility:hidden"/>
        <input type="text" name="perAnoVigDel" id="perAnoVigDel" size="1" maxlength="40" value="0" style="visibility:hidden"/>
        <input type="text" name="perMesVigDel" id="perMesVigDel" size="1" maxlength="40" value="0" style="visibility:hidden"/>
        <input type="text" name="perDiaVigDel" id="perDiaVigDel" size="1" maxlength="40" value="0" style="visibility:hidden"/><input type="text" name="perCargoFide" id="perCargoFide" size="1" maxlength="40" value=" " style="visibility:hidden"/>
        <input type="text" name="perAnoVigAl" id="perAnoVigAl" size="1" maxlength="40" value="0" style="visibility:hidden"/>
        <input type="text" name="perMesVigAl" id="perMesVigAl" size="1" maxlength="40" value="0" style="visibility:hidden"/>
        <input type="text" name="perDiaVigAl" id="perDiaVigAl" size="1" maxlength="40" value="0" style="visibility:hidden"/>
        <input type="text" name="perNumContrato" id="perNumContrato" size="1" maxlength="40" value="0" style="visibility:hidden"/>
        <input type="text" name="perNumNivel1" id="perNumNivel1" size="1" maxlength="40" value="1000" style="visibility:hidden"/>
        <input type="text" name="perNumNivel2" id="perNumNivel2" size="1" maxlength="40" value="10" style="visibility:hidden"/>
        <input type="text" name="perNumNivel3" id="perNumNivel3" size="1" maxlength="40" value="0" style="visibility:hidden"/>
        <input type="text" name="perNumNivel4" id="perNumNivel4" size="1" maxlength="40" value="0" style="visibility:hidden"/>
        <input type="text" name="perNumNivel5" id="perNumNivel5" size="1" maxlength="40" value="0" style="visibility:hidden"/>
