        ...
        <table width="100%" align="center" class="texto">
          <tr>
            ...
            <td nowrap width="15%">Fideicomiso</td>
              <td nowrap colspan="2">
                <select size="1" name="paramfiso" id="paramfiso" ref="cmbFideicomisoTrac" fun="loadComboElement" keyValue="femiNumFideicomiso" theValue="femiNomFideicomiso"  param="cmbFideicomisoTrac" next="formsLoaded"/>
          ...
          <tr>
            ...
            <table width="224" cellpadding="0" cellspacing="0">
                ...
                <td width="112"  align="center" valign="middle">
                  <input type="BUTTON" value="Aceptar" id="cmdAceptar" name="Aceptar" class="boton_left" onmouseover="this.className='boton_leftSobre'" onmouseout="this.className='boton_left';" ref="qryParamTrack" fun="loadTableElement" tabla="tabla" onclick="if(fvMantenimiento.checkForm())consultar(this, GI('frmDatos'), false);">
                  </td>
                  <td width="112" align="center" valign="middle">
            ...
            <td colspan="5">
              <table cellspacing="0" cellpadding="0" border="0">
                <tr align="left" class="cabeceras">
                  <td width="23px">&nbsp;</td>
                  <td width="100px">Pizarra</td>
                  <td width="80px">Serie</td>
                  <td width="80px">Cupón</td>
                  <td width="100px">Hr Inicio</td>
                  <td width="100px">Hr Finalización</td>
                  <td width="100px">Ampliar Hr</td>
                  <td width="100px">Máximo Creaciones Día</td>
                  <td width="100px">Máximo Creaciones CB</td>
                  <td width="100px">Unidades por Certificado</td>
                  <td width="80px">Estatus</td>
                </tr>
              </table>
              <div style="height:250px; overflow:auto; position:relative; vertical-align:top;">
                <table id="tabla" border="0" cellspacing="0" cellpadding="0" dataInfo="tablaData" keys="patIdPizarra,patIdSerie,patIdCupon" fun="clickTabla" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de búsqueda">
                </table>
              </div>
            </td>
          </tr>
