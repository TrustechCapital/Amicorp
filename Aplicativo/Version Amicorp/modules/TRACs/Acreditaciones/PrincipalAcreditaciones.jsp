      ...
      <td height="100%">
        <table width="100%" align="center" class="texto">
          <tr>
            ...
            <td>
              <select size="1" name="paramCasaBolsa" id="paramCasaBolsa" ref="cmbCasasBolsa" fun="loadComboElement" keyValue="cveNumSecClave" theValue="cveDescClave"  param="clavesCombo26" next="formsLoaded"/>
            </td>
            <td width="45%">
              &nbsp;
            </td>
          ...
          <tr>
            ...
            <table width="224" cellpadding="0" cellspacing="0">
                ...
                <td width="112"  align="center" valign="middle">
                  <input type="BUTTON" value="Aceptar" id="cmdAceptar" name="Aceptar" class="boton_left" onmouseover="this.className='boton_leftSobre'" onmouseout="this.className='boton_left';" ref="qryAcreditacionTrack" fun="loadTableElement" tabla="tabla" onclick="if(fvMantenimiento.checkForm())consultar(this, GI('frmDatos'), false);">
                  </td>
                  <td width="112" align="center" valign="middle">
            ...
            <td colspan="5">
              <table cellspacing="0" cellpadding="0" border="0">
                <tr align="left" class="cabeceras">
                  <td width="23px">&nbsp;</td>
                  <td width="50px">No CB</td>
                  <td width="200px">Casa de Bolsa</td>
                  <td width="50px">Riesgo</td>
                  <td width="100px">Cta Indeval</td>
                  <td width="100px">Fec Aceptación</td>
                  <td width="80px">Estatus</td>
                </tr>
              </table>
              <div style="height:250px; overflow:auto; position:relative; vertical-align:top;">
                <table id="tabla" border="0" cellspacing="0" cellpadding="0" dataInfo="tablaData" keys="acrIdIntermediario" fun="clickTabla" radioWidth="23" NoRecordsMsg="No existen Registros para estos criterios de búsqueda">
                </table>
              </div>
            </td>
          </tr>
