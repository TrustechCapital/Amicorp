...
<html>
  ...
  <body style="background-color:transparent;">
   <center> 
    <form name="frmValuacion" enctype="multipart/form-data" method="post" action="<%=request.getContextPath()%>/upload.do">
      
      <input type="hidden" id="fechaValuacion" name="fechaValuacion" value=""/>
      <input type="hidden" id="nombreValuacion" name="nombreValuacion" value=""/>
      ...
      <input class="texto" type="hidden" value="Aceptar" onclick="parent.frameSubmit(frmValuacion);" name="Aceptar"/>
