...
<%response.setHeader("Content-Disposition","attachment; filename=\"Conciliacion_Diaria.xls\"");%>
...
{ 
    ...
    diferencia_dep=DecimalFormatUtils.getFormatedNumber("###,###,###,###.00", diferencia_depositos);
        
    diferencia_retiros = diferencia_retiros.add(new BigDecimal(((String)registro.get("frcFoliosConcExt")).split("---")[1]));
    diferencia_ret=DecimalFormatUtils.getFormatedNumber("###,###,###,###.00", diferencia_retiros);           
}
...
<html>
<head>
<title>REPORTE CONCILIACION</title>
</head>
<body>
...
<table border='0' bordercolor='#000000' bgcolor='#FFFFFF'>
        ...
        <tr><td align="center" style="font-family: Arial;	font-size: 12px;color: #000000;font-weight: bold;">REPORTE CONCILIACION DEL <%=fecha%></td></tr>
			</table>
		</td>
		<td>
			<table> 
...
<tr><td><hr width="960" size="1"> </td></tr>
          ...
          <P>&nbsp;</P>
<table width="900"  border="0" cellpadding="2" align="center"  style='font-family: Arial;	font-size: 10px;color: #000000;'>
          <tr>
            <td colspan="5" align='center'  style="font-family: Arial;	font-size: 13px;color: #000000;font-weight: bold;">Diferencia en Depositos:&nbsp;&nbsp;<%=diferencia_dep%></td>
            <td colspan="5" align='center'  style="font-family: Arial;	font-size: 13px;color: #000000;font-weight: bold;">Diferencia en Retiros:&nbsp;&nbsp;<%=diferencia_ret%></td>
          </tr>
          <tr>
            <td colspan="10" align='center'>&nbsp;</td>
          </tr>
          <tr>
              <td align="center" colspan="5" width="450" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;font-weight: bold;">MOVIMIENTOS EXTERNOS</td>
              <td align="center" colspan="5" width="450" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;font-weight: bold;">MOVIMIENTOS FIDUCIA</td>              
          </tr>
          <tr>
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;">Folio</td>
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;"></td>             
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;">Importe</td>
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;">Folios Conciliados</td>
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;">Estatus</td> 
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;">Folio</td>
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;">Cuenta</td>
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;">Importe</td>
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;">Estatus</td> 
              <td align="center" width="100" bgcolor="#999999" style="font-family: Arial;	font-size: 12px;color: #000000;">Tipo Movto</td> 
          </tr>
          ...
          <tr style="font-family: Arial;	font-size: 10px;color: #000000;">   
            ...
            <td  align="right" width="100"><%=(importe_mov_ext==null)?"":importe_mov_ext%></td> 
            ...
            <%}else if(folios_conc_ext.equals("SIN CONCILIAR")){out.write("<td colspan='5' align='center'></td><td colspan='5' align='center'>"+folios_conc_ext+"</td>");
