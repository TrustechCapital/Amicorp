      ...
      <td height="100%">
        <table align="center" class="texto" width="90%">
          ...
          <tr>
            ...
            <td>
              <select name="paramTipoOperacion" id="paramTipoOperacion" ref="claves" fun="loadComboElement" keyValue="cveDescClave" theValue="cveDescClave" next="formsLoaded" param="clavesCombo702" onchange="this.disabled=true;" required message="El Tipo de Operaci�n es un campo obligatorio"/>
            </td>
            <td width="25%">&nbsp;</td>
          </tr>
          <tr>
          ...
          <tr>
            <td colspan="4" align="center">
              <input type="button" value="Aceptar" name="cmdAceptar" id="cmdAceptar" class="boton" ref="qryOperacionesRelevantes" fun="loadTableElement" tabla="tblReg" onclick="consultaOperacionesRelevantes(this)"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
