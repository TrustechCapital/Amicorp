  ...
  <table cellspacing="1" cellpadding="1" border="0" width="100%" align="center" style="height:auto;">
    ...
    <tr>
      <td align="center" valign="middle" width="15%">&nbsp;
        ...
        <input type="BUTTON" name="cmdLimpiar" id="cmdLimpiar" value="Limpiar" class="boton" onclick="onButtonClickPestania('Tesoreria.EntradasSalidas.PrincipalEntradasSalidas','');"/>
      </td>
    </tr>
    <tr>
      <td height="100%">&nbsp;</td>
