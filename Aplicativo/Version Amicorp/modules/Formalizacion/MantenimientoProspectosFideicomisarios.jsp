          ...
          <table width="100%" class="texto">
            ...
            <tr>
             ...
             <tr>
              ...
              <td>
                <select id="afbNomPais" name="afbNomPais" ref="clavePais" fun="loadComboElement" keyValue="paiNomPais" theValue="paiNomPais" next="loadCatalogo" required message="El País es un campo obligatorio"/>
              </td>
              <td width="10%">&nbsp;</td>
            </tr>
